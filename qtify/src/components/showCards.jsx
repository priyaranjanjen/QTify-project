import React, { useState, useEffect, useMemo } from "react"; // Import useState and useEffect directly from react
...
export default function RenderCards({ text, type }) {
  ...
  const [collapse, setCollapse] = useState(true); // Set initial state to false for collapse
